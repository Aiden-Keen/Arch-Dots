...
import { FileText, Lightbulb, Instagram, Video, Vault } from "lucide-react";
...
export default function DashboardPageUI() {
    ...
    const { user, stats, recomputeFromHistory } = useUsageStore();
    ...
    const statsItems = [
        ...
        { label: "TESTING", value: 999}
    ];

    return (
        <div className="h-screen bg-gray-50">
            <div className="h-20 border-b-[1px] flex items-center gap-6 px-6">
            ...
            <div className="p-6">
                    <UsageLineChart />
                <div className="mb-6 flex flex-row gap-6 mt-6">
                    <UsageDonut />
